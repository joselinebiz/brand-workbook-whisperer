...
const Index = () => {
  ...
  const workbooks = [
    ...
    },
    {
      ...
      description: "Implement systems and processes to scale your business sustainably.",
      path: "/workbook/4",
        ...
        <div className="container mx-auto px-4 py-24 relative z-10">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Button 
              variant="hero" 
              size="lg" 
              onClick={() => document.getElementById('workbooks')?.scrollIntoView({ behavior: 'smooth' })}
            >
              Start Your Journey
            </Button>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-chatone mb-4">The Complete Journey</h2>
