        ...
        <Card className="p-8 mb-8 bg-gradient-to-br from-card to-muted/20">
          ...
          <div className="bg-muted/50 border-l-4 border-muted-foreground p-4 rounded mb-6">
            ...
            <ul className="text-sm space-y-1">
              ...
              <li className="font-semibold text-primary">WORKBOOK 1: Brand foundation built (you're here!)</li>
              <li>→ WORKBOOK 2: Strategic marketing system that aligns with your brand</li>
              <li>→ WORKBOOK 3: Automated customer experience that builds loyalty</li>
...
Cite your sources for each claim in your response. Flag any assumptions, inferences, or gaps you filled in without direct evidence.`}
        ...
        <div className="flex justify-between gap-4">
          <Button variant="outline" size="lg" asChild>
            <Link to="/workbook/0">← Back to Workbook 0</Link>
          </Button>
          ...
          <Button variant="hero" size="lg" asChild>
            <Link to="/workbook/2">Continue to Workbook 2: Marketing Strategy →</Link>
          </Button>
        </div>
      </div>
      </div>
